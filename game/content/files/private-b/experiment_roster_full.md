...
AUTHOR: ORPHEUS ROSTER SERVICE / UNSIGNED EDIT
SOURCE: B TERMINAL / PERSONNEL ARCHIVE
STATUS: B-SIDE COPY — IDENTITY FIELDS CONFLICT

受試者名冊／B 端可見版本

這份名冊把 A 標成研究員，把 B 標成參與者，卻又在備註欄把兩人放進同一個實驗單位。

版本差異：A 端附件寫著「共同求證」，這份名冊卻把它改成「服從指示」。

修改沒有留下人工覆核姓名。請把兩份文件交給對方，不要只根據本端看到的版本作答。
