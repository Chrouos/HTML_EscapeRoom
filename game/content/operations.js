...
const operations = Object.freeze([
  ...
  op('pause_local_mirror', 'private', { all: [{ publicFact: 'accessLogOpened' }, { entryOpened: 'log.token_reissue' }] }, { roleFacts: ['bPausedLocalMirror'], completeNodeIds: ['mission.b2.completed'] }),
  op('keep_local_mirror', 'private', { all: [{ publicFact: 'accessLogOpened' }, { entryOpened: 'log.token_reissue' }] }, { roleFacts: ['b2KeptMirror'], completeNodeIds: ['mission.b2.kept'] }),
  op('warn_partner_first', 'private', { all: [{ publicFact: 'accessLogOpened' }, { entryOpened: 'log.token_reissue' }] }, { roleFacts: ['bWarnedPartner'], completeNodeIds: ['mission.b2.warned'] }),
  op('skip_b2', 'private', { all: [{ publicFact: 'accessLogOpened' }, { entryOpened: 'log.token_reissue' }] }, { roleFacts: ['b2Skipped'], completeNodeIds: ['mission.b2.skipped'] }),
  ...
  op('publish_fragment', 'private', { all: [{ publicFact: 'main5Completed' }, { entryOpened: 'doc.a_solo_protocol' }] }, { roleFacts: ['aPublishedFragment'], completeNodeIds: ['mission.a3.published'] }),
  op('request_pair_validation', 'private', { all: [{ publicFact: 'main5Completed' }, { entryOpened: 'doc.a_solo_protocol' }] }, { roleFacts: ['a3RequestedPair'], completeNodeIds: ['mission.a3.paired'] }),
  op('skip_a3', 'private', { all: [{ publicFact: 'main5Completed' }, { entryOpened: 'doc.a_solo_protocol' }] }, { roleFacts: ['a3Skipped'], completeNodeIds: ['mission.a3.skipped'] }),
  ...
  op('file_anonymous_summary', 'private', { all: [{ publicFact: 'main5Completed' }, { entryOpened: 'log.b_partner_unknown_access' }] }, { roleFacts: ['bFiledAnonymousSummary'], completeNodeIds: ['mission.b3.anonymous'] }),
  op('disclose_report', 'private', { all: [{ publicFact: 'main5Completed' }, { entryOpened: 'log.b_partner_unknown_access' }] }, { roleFacts: ['bDisclosedReport'], completeNodeIds: ['mission.b3.disclosed'] }),
