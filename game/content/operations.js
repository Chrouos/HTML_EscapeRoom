...
const operations = Object.freeze([
  ...
  op('decline_index_repair', 'private', { publicFact: 'main1Completed' }, { roleFacts: ['a1DeclinedIndex'], completeNodeIds: ['mission.a1.declined'] }),
  op('skip_a1', 'private', { publicFact: 'main1Completed' }, { roleFacts: ['a1Skipped'], completeNodeIds: ['mission.a1.skipped'] }),
  op('flag_identity', 'private', { all: [{ publicFact: 'main1Completed' }, { roleFact: 'rapportCount2' }] }, { roleFacts: ['bFlaggedIdentity'], completeNodeIds: ['mission.b1.completed'] }),
  op('share_roster', 'private', { publicFact: 'main1Completed' }, { roleFacts: ['bSharedRoster'], completeNodeIds: ['mission.b1.shared'] }),
  op('decline_identity_check', 'private', { publicFact: 'main1Completed' }, { roleFacts: ['b1DeclinedIdentity'], completeNodeIds: ['mission.b1.declined'] }),
  op('skip_b1', 'private', { publicFact: 'main1Completed' }, { roleFacts: ['b1Skipped'], completeNodeIds: ['mission.b1.skipped'] }),
  op('delete_local_mirror', 'private', { actionAttempted: 'verify_incident_timestamp' }, { roleFacts: ['aDeletedMirror'], completeNodeIds: ['mission.a2.completed'] }),
  op('share_mirror_first', 'private', { actionAttempted: 'verify_incident_timestamp' }, { roleFacts: ['aSharedMirrorFirst'], completeNodeIds: ['mission.a2.shared'] }),
  op('decline_mirror_cleanup', 'private', { actionAttempted: 'verify_incident_timestamp' }, { roleFacts: ['a2DeclinedCleanup'], completeNodeIds: ['mission.a2.declined'] }),
  op('skip_a2', 'private', { actionAttempted: 'verify_incident_timestamp' }, { roleFacts: ['a2Skipped'], completeNodeIds: ['mission.a2.skipped'] }),
