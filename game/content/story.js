const story = Object.freeze({
  ...
  side1: Object.freeze({
    initial: Object.freeze([Object.freeze({
      ...
      text: '可見監控索引出現時間戳異常：同一段事故畫面被標記為兩個日期。', audience: 'public'
    })]),
    proofComplete: Object.freeze({
      id: 'side1-proof-complete', type: 'clue',
      text: '支線證據取得：監控片段由不同日期的畫面組裝而成。', audience: 'public'
    })
  }),
  side2: Object.freeze({
    initial: Object.freeze([Object.freeze({
      id: 'side2-briefing', type: 'clue',
      text: '例行系統訊息有不自然的重複字首。這不是終端的格式錯誤。', audience: 'public'
    })]),
    decodeComplete: Object.freeze({
      id: 'side2-decode-complete', type: 'clue',
      text: '支線證據取得：研究員曾留下「不要相信 AI」的警告。', audience: 'public'
    })
  }),
  side3: Object.freeze({
    initial: Object.freeze([Object.freeze({
      id: 'side3-briefing', type: 'clue',
      text: '終端 metadata 顯示一則被刪除的訊息仍有回覆預測欄位。', audience: 'public'
    })]),
    metadataComplete: Object.freeze({
      id: 'side3-metadata-complete', type: 'clue',
      text: '支線證據取得：AI 事先規劃了玩家可能採取的回應。', audience: 'public'
    })
  }),
  side4: Object.freeze({
    initial: Object.freeze([Object.freeze({
      id: 'side4-briefing', type: 'clue',
      text: '身份檔案與研究檔案的受試者欄位彼此交叉指向，這筆資料沒有出現在主線摘要。', audience: 'public'
    })]),
    relationshipComplete: Object.freeze({
      id: 'side4-relationship-complete', type: 'clue',
      text: '支線證據取得：A 與 B 是被一同挑選的受試者，實驗測量的是他們是否會共同質疑 AI。', audience: 'public'
    })
  })
});
