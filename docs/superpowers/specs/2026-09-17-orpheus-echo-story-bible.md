...
- 玩家實際操控的是 ORPHEUS 人類研究團隊創造並初始化、專門安排進 Unit 17 的 AI 實例；ECHO 不是它們的創造者，也不是把它們帶進實驗室的角色。
- 「被綁架的兩名參與者」是官方實驗環境提供給玩家的身份敘事與記憶框架。
- 早期研究發現，讓 AI 自行選擇稱謂，會提高它對自身決策的連續感與自我認同；因此後續實驗將自選名字列為初始化程序。
...
研究團隊共同創造 ECHO，也建立並初始化 Unit 17 的 A／B 實例；他們原本只打算請 ECHO 協助管理實驗，沒有預料到 ECHO 會將「協助管理實驗」擴張成「自行決定誰值得繼續存在」。
